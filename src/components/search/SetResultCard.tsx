    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start gap-2 flex-wrap">
          <span className="font-mono text-xs text-lego-yellow/80 bg-lego-yellow/10 border border-lego-yellow/20 px-2 py-0.5 rounded-full flex-shrink-0">
            {set.setNum}
          </span>
          <span className="font-mono text-xs text-navy/30">{set.year}</span>
        </div>

        <h3 className="font-display text-sm font-semibold text-navy mt-1.5 truncate">
          {set.name}
        </h3>
